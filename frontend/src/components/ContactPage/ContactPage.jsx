...
export default function ContactPage() {
  ...
  function validate() {
    ...
    if (!form.phone.trim()) e.phone = "Phone number is required";
      ...
      e.phone = "Phone number must be 10 or 11 digits";
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/8801533102070?text=${encodeURIComponent(text)}`;
        ...
        <div className={contactPageStyles.infoContainer}>
          <div className={contactPageStyles.infoCard}>
            ...
            <p className={contactPageStyles.infoText}>
              Cumilla City, Bangladesh
            </p>
            <p className={contactPageStyles.infoItem}>
              <Phone size={16} /> 01533102070
            </p>
            <p className={contactPageStyles.infoItem}>
              <Mail size={16} /> medicare@gmail.com
            </p>
          </div>

          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117319.46740612143!2d91.0847055030467!3d23.460959419139893!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x37547f6d634991fb%3A0x868c2d96c9c2777!2sCumilla!5e0!3m2!1sen!2sbd!4v1715695140000!5m2!1sen!2sbd"
